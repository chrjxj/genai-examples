...
class GaussianDiffusion(object):
    ...
    def p_mean_variance(self,
        ...
        if guide_scale is None:
            ...
            y_out = model.infer({"x":xt, "t":self._scale_timesteps(t), "y":model_kwargs[0]["y"]})['output'].detach().clone()
            u_out = model.infer({"x":xt, "t":self._scale_timesteps(t), "y":model_kwargs[1]["y"]})['output'].detach().clone()
